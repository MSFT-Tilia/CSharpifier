namespace CalculatorApp
{
    ...
    public class App
    {
        ...
        internal void RemoveWindow ( _In_ WindowFrameService frameService ) { throw new NotImplementedException(); /* CSharpifier Warning */ }
        internal void RemoveSecondaryWindow ( _In_ WindowFrameService frameService ) { throw new NotImplementedException(); /* CSharpifier Warning */ }
        private static void SetMinWindowSizeAndActivate ( Windows . UI . Xaml . Controls . Frame rootFrame , Windows . Foundation . Size minWindowSize ) { throw new NotImplementedException(); /* CSharpifier Warning */ }
        ...
        private concurrency::task<void> HandleViewReleaseAndRemoveWindowFromMap ( _In_ WindowFrameService frameService ) { throw new NotImplementedException(); /* CSharpifier Warning */ }
        private void AddWindowToMap ( _In_ WindowFrameService frameService ) { throw new NotImplementedException(); /* CSharpifier Warning */ }
        private void RemoveWindowFromMap ( int viewId ) { throw new NotImplementedException(); /* CSharpifier Warning */ }
    }
...
wReleaseAndRemoveWindowFromMap(_In_WindowFrameService^frameService) { throw new NotImplementedException(); /* CSharpifier Warning */ }
